...
// ACT. 29-09-2024
// Segun GitHub, se debe añadir una variable aqui
// Tanto en el archivo eHealthDisplay.h como en eHealthDisplay.cpp
#define prog_uint8_t const uint8_t // <-- Esta es la linea agregada
